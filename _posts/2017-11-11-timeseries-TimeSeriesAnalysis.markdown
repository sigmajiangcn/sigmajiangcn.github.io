...
分解历史数据得到下图：
![@时间序列分解](./with_summer_dpi_nofuture.png)
...
![@暑假和非暑假的week周期波动差异](./fft_period1.jpg)
